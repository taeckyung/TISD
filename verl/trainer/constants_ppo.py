...
PPO_RAY_RUNTIME_ENV = {
    "env_vars": {
        ...
        # deep_gemm's prebuilt .so registers op schemas that are ABI-incompatible
        # with torch 2.9.0 (std::length_error in FunctionSchema schema parse ->
        # SIGABRT during vLLM kernel warmup). It is FP8-only and unused for bf16
        # models, so disable it to skip the crashing import.
